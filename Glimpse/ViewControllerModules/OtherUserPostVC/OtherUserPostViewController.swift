...
import AVFoundation
import AVKit
class OtherUserPostViewController: UIViewController,UITableViewDelegate,UITableViewDataSource, WebServiceDelegate {
    var player : AVPlayer?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        lblUserName.text = dictDetail.value(forKey: "firstName") as? String
        
        imgUser.af_setImage(withURL: URL(string:(dictDetail.value(forKey: "image") as? String)!)!)
    ...
    func getPosts()
    {
        ...
        dict.setObject(dictDetail.value(forKey: "id") as! String, forKey: USER.kUSERID as NSCopying)
