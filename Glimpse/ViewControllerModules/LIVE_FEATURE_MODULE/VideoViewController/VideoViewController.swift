...
class VideoViewController: UIViewController, WZStatusCallback, WZVideoSink,WZAudioSink {
    ...
    let SDKSampleAppLicenseKey = "GOSK-8044-0103-4686-C4D6-C87E"
    ...
    override func viewDidLoad() {
        ...
        /*
        viewModel?.hostAddress          = "54.193.48.159"
        viewModel?.streamName           = "85f9ab9f"
        viewModel?.applicationName      = "app-9f0b"
        viewModel?.port                 = "1935"
        viewModel?.username             = "client27653"
        viewModel?.password             = "6c41fed8"
 
         */
        
        viewModel?.hostAddress          = "54.183.249.15"
        viewModel?.streamName           = "49e0cd58"
        viewModel?.applicationName      = "app-18c0"
        viewModel?.port                 = "1935"
        viewModel?.username             = "client27653"
        viewModel?.password             = "50497220"
