...
class ChatViewController: QMChatViewController, QMChatServiceDelegate, UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, QMChatAttachmentServiceDelegate, QMChatConnectionDelegate, QMChatCellDelegate, QMDeferredQueueManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let currentUser:QBUUser = ServicesManager.instance().currentUser {
            ...
            self.inputToolbar?.contentView?.textView?.placeHolder = "Type a message..".localized
    ...
    override func attributedString(forItem messageItem: QBChatMessage!) -> NSAttributedString? {
        ...
        let attributedString = NSAttributedString(string: messageItem.text!, attributes: attributes as [String : Any])
