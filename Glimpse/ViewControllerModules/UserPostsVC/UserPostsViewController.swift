...
import AVFoundation
import AVKit
class UserPostsViewController: UIViewController,UITableViewDelegate,UITableViewDataSource, WebServiceDelegate {
    var player : AVPlayer?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print(UserDefaults.standard.value(forKey:EXTRA.kAPI_LOGIN_DATA ) as! NSDictionary)
        lblUserName.text = (UserDefaults.standard.value(forKey:EXTRA.kAPI_LOGIN_DATA ) as! NSDictionary).value(forKey: "firstName") as? String
        
        imgUser.af_setImage(withURL: URL(string:((UserDefaults.standard.value(forKey:EXTRA.kAPI_LOGIN_DATA ) as! NSDictionary).value(forKey: "image") as? String)!)!)
    ...
    func getPosts()
    {
        ...
        dict.setObject("profile", forKey: "type" as NSCopying)
