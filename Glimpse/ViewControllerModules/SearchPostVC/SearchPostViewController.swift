...
class SearchPostViewController: UIViewController, UISearchResultsUpdating, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, WebServiceDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let moveUserProfileTableViewController = Alert.GET_VIEW_CONTROLLER(identifier: "OtherUserPostViewController") as! OtherUserPostViewController
        moveUserProfileTableViewController.dictDetail = arrList[indexPath.row] as! NSDictionary
