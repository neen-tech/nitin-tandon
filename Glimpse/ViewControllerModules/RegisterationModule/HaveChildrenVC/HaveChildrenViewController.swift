//
//  HaveChildrenViewController.swift
//  Glimpse
//
...
class HaveChildrenViewController: UIViewController,UITableViewDataSource,UITableViewDelegate, WebServiceDelegate {

    @IBOutlet weak var imageViewBG: UIImageView!
    @IBOutlet weak var tableViewHaveChildren: UITableView!
    
    
    var arrayHaveChildren = NSArray()
    ...
    func getOptions()
    {
        ...
        dict.setObject("Do You Have Children?", forKey: USER.kQUESTION as NSCopying)
    ...
    func configView() {
        ...
        self.tableViewHaveChildren.tableFooterView = UIView.init()
        self.tableViewHaveChildren.dataSource = self
        self.tableViewHaveChildren.delegate = self
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return  self.arrayHaveChildren.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "HaveChildrensCell", for: indexPath) as! GlobalTableViewCell
        
        let body = self.arrayHaveChildren.object(at: indexPath.row) as! NSDictionary
    ...
    func getDataFormWebService(jsonResult: NSDictionary, methodName: NSString) {
        ...
        if methodName.isEqual(to: APIMETHOD.kAPI_GET_OPTIONS_BY_QUESTION) {
            ...
            self.arrayHaveChildren = (jsonResult.object(forKey: EXTRA.kAPI_OPTIONS as NSString) as? NSArray)?.mutableCopy() as! NSMutableArray
            
            tableViewHaveChildren.reloadData()
            
        }
        else if methodName.isEqual(to: APIMETHOD.kAPI_UPDATE_ADVANCE_OPTION) {
            
            let hightestEducationViewController = Alert.GET_VIEW_CONTROLLER(identifier: SB_ID.SBI_HIGHEST_EDUCATION_VC as NSString) as! HightestEducationViewController
            
            self.MOVE(vc: hightestEducationViewController, animated: true)
        }
        //
